...
#
# 본 셋업의 stage 위치:
#   - stage 0: NODE 0 = p3dn.24xlarge (8× V100 48GB) — TP=8 intra-node
#   - stage 1: NODE 1 = p4dn.24xlarge (8× A100 40GB) — TP=8 intra-node + lm_head
#
# Usage:
...
echo "=== PP=2 TP=8 sweep — cluster=p3dn_24xl__p4dn_24xl model=qwen3_14b ==="
