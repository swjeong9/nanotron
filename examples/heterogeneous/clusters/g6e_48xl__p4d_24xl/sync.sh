#!/usr/bin/env bash
# 2-node sync (g6e.48xlarge + p4d.24xlarge) — examples/heterogeneous + src/nanotron + run_train.py
...
echo "[sync] target NODE 0 (g6e.48xlarge, stages 0+1): $NODE0_IP"
echo "[sync] target NODE 1 (p4d.24xlarge,  stages 2+3): $NODE1_IP"
...
CRITICAL_FILES=(
    "run_train.py"
    "examples/heterogeneous/clusters/g6e_48xl__p4d_24xl/launch_node0.sh"
    "examples/heterogeneous/clusters/g6e_48xl__p4d_24xl/launch_node1.sh"
    "examples/heterogeneous/configs/qwen3_14b/alpaca_pp4_tp4.yaml"
    "examples/heterogeneous/configs/qwen3_14b/alpaca_pp2_tp8.yaml"
    "examples/heterogeneous/configs/qwen3_14b/alpaca_pp8_tp2.yaml"
    "examples/heterogeneous/configs/qwen3_14b/alpaca_pp16_tp1.yaml"
